...
def build_decoder(net):
    ...
    net['uconv5_3d'] = lasagne.layers.DropoutLayer(net['uconv5_3'], p=0.2)
    print "uconv5_3d: {}".format(net['uconv5_3d'].output_shape[1:])

    net['uconv5_2'] = ConvLayer(net['uconv5_3d'], 512, 3, pad=1)
    print "uconv5_2: {}".format(net['uconv5_2'].output_shape[1:])

    net['uconv5_2d'] = lasagne.layers.DropoutLayer(net['uconv5_2'], p=0.2)
    print "uconv5_3d: {}".format(net['uconv5_2d'].output_shape[1:])

    net['uconv5_1'] = ConvLayer(net['uconv5_2'], 512, 3, pad=1)
    print "uconv5_1: {}".format(net['uconv5_1'].output_shape[1:])

    net['uconv5_1d'] = lasagne.layers.DropoutLayer(net['uconv5_1'], p=0.2)
    print "uconv5_1d: {}".format(net['uconv5_1d'].output_shape[1:])

    net['upool4'] = Upscale2DLayer(net['uconv5_1'], scale_factor=2)
    print "upool4: {}".format(net['upool4'].output_shape[1:])

    net['upool4d'] = lasagne.layers.DropoutLayer(net['upool4'], p=0.2)
    print "upool4d: {}".format(net['upool4d'].output_shape[1:])

    net['uconv4_3'] = ConvLayer(net['upool4d'], 512, 3, pad=1)
    print "uconv4_3: {}".format(net['uconv4_3'].output_shape[1:])

    net['uconv4_3d'] = lasagne.layers.DropoutLayer(net['uconv4_3'], p=0.2)
    print "uconv4_3d: {}".format(net['uconv4_3d'].output_shape[1:])

    net['uconv4_2'] = ConvLayer(net['uconv4_3'], 512, 3, pad=1)
    print "uconv4_2: {}".format(net['uconv4_2'].output_shape[1:])

    net['uconv4_2d'] = lasagne.layers.DropoutLayer(net['uconv4_2'], p=0.2)
    print "uconv4_2d: {}".format(net['uconv4_2d'].output_shape[1:])

    net['uconv4_1'] = ConvLayer(net['uconv4_2'], 512, 3, pad=1)
    print "uconv4_1: {}".format(net['uconv4_1'].output_shape[1:])

    net['uconv4_1d'] = lasagne.layers.DropoutLayer(net['uconv4_1'], p=0.2)
    print "uconv4_1d: {}".format(net['uconv5_3d'].output_shape[1:])

    net['upool3'] = Upscale2DLayer(net['uconv4_1'], scale_factor=2)
    print "upool3: {}".format(net['upool3'].output_shape[1:])

    net['upool3d'] = lasagne.layers.DropoutLayer(net['upool3'], p=0.2)
    print "upool3d: {}".format(net['upool3d'].output_shape[1:])
